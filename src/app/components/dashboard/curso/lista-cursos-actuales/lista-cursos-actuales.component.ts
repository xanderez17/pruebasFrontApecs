...
import { OPCrearInscripcionComponent } from '../../Inscripciones/opcrear-inscripcion/opcrear-inscripcion.component';
...
@Component({
  selector: 'app-lista-cursos-actuales',
  templateUrl: './lista-cursos-actuales.component.html',
  styleUrls: ['./lista-cursos-actuales.component.css'],
})
export class ListaCursosActualesComponent implements OnInit {
  estado: any;
  ...
  openDialogInscribir(id: any) {
    this.dialog.open(OPCrearInscripcionComponent, {
      data: { anyProperty: id },
    });
  }
